        ...
        <main class="signup-form-container">
          <form class="signup-form">
            ...
            <div class="form-group">
              ...
              <input type="text" id="name" class="form-input" placeholder="Michel Doe" />
            </div>
            <div class="form-group">
              <label for="email" class="form-label">Your Email*</label>
              <input type="email" id="email" class="form-input" placeholder="youremail@example.com" />
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="tel" id="whatsapp" class="form-input" placeholder="0852xxxxxxxx" />
            </div>
            <button type="submit" class="signup-button">Sign Up</button>
            <div class="login-link">
              <span>Already Have an account ?</span>
              <a href="#" class="login-text">Log In here</a>
            </div>
          </form>
        </main>
      </div>
